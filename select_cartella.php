        ...
        if(mysqli_num_rows($query) == 1) {
            ...
            // No, non ce l'ha
                ...
                if(isset($_POST['cartella'])) {
                    ...
                    $query = mysqli_query($dbh, "select a.idcartella
                                                 from ".PREFIX."avere a left join ".PREFIX."utente u
                                                 on a.idutente = u.idutente
                                                 where u.idserver = '$idserver'
                                                 and a.idcartella = '$cartella';");
                ...
                // Se non ha richiesto una cartella ne carico una random
                    ...
                    $query = mysqli_query($dbh, "select idcartella
                                                 from ".PREFIX."cartella
                                                 where idcartella not in ( select c.idcartella
                                                                           from ".PREFIX."cartella c, ".PREFIX."avere a, ".PREFIX."utente u, ".PREFIX."server s
                    ...
                    $query = mysqli_query($dbh, "select co.idnumero, co.riga
                                                 from ".PREFIX."cartella c inner join ".PREFIX."comporre co
                                                 on co.idcartella = c.idcartella
                                                 where c.idcartella = '$cartella';");
            ...
            redirect(WEBSITE.'client_login.php');
        }
?>
